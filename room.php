...
<body id="page-top">
    ...
    <div class="container-fluid p-0">
        <div class="row ">
            <div class="col">
                <img style="width: 100%; height:78%;" src="<?= $objResult['head_pic'];?>">
            </div>
        </div>
        <div class="row stan p-5">
            ...
            <div class="col text-center border-right">
                ...
                $objResult['wifi'] == 'yes' ?  "Free Wifi" :  "No Wifi" ?> </p>
            </div>
            <div class="col text-center border-right">
    ...
    <div class="container imgstan">
        <div class="row ">
            <div class="col p-4">
                <img style="width: 90%; height:100%;" src="<?= $objResult['buttom_pic'];?> ">
            </div>
            <div class="col ">
                <p class="standard"><?= $_GET['name']; ?></p><br>
                <p class="textstan"><?= $objResult['text'];?> </p>
