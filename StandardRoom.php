...
<body id="page-top">
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col">
                <img style="width: 100%; height:78%;" src="images/ko.jpg">
            </div>
        </div>
        <div class="row stan p-5">
        ...
        <div class="row ">
            <div class="col p-4">
                <img style="width: 90%; height:100%;"
                    src="https://images.mrandmrssmith.com/images/1736x1302/4705779-soori-bali-bali-indonesia.jpg">
            </div>
            <div class="col ">
                <p class="standard">Standard Room</p><br>
                <p class="textstan">modern room with amenities for a peaceful stay.</p>
